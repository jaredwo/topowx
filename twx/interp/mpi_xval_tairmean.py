...
import sys
from db.station_data import station_data_infill,STN_ID,MEAN_OBS,MASK,BAD,DTYPE_STN_MEAN_LST_TDI_OPTIMNNGH_VARIO
...
from interp.optimize import XvalTairMean
r = robjects.r
