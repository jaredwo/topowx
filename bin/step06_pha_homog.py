...
if __name__ == '__main__':
    ...
    FPATH_PHA_RUNS = os.path.join(PROJECT_ROOT, 'inhomo_software', 'update_2014')
    ...
    path_pha_tar = os.path.join(PROJECT_ROOT, 'inhomo_software', 'pha_src', 'phav52i.tar.gz')
    
    path_stndb = os.path.join(FPATH_STNDATA, 'all', 'tair_tobs_adj_1948_2014.nc')
    ...
    path_out_homog_db = os.path.join(FPATH_STNDATA, 'all', 'tair_homog_1948_2014.nc')    
    ...
    fpath_por_out = os.path.join(FPATH_STNDATA, 'all', 'homog_por_1948_2014.csv')
