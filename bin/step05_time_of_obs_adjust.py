...
if __name__ == '__main__':
    ...
    fpath_por = os.path.join(FPATH_STNDATA, 'all', 'all_por_1948_2012.csv')
    fpath_stn_db = os.path.join(FPATH_STNDATA, 'all', 'all_1948_2012.nc')
    ...
    fpath_db_tobs_adj_out =  os.path.join(FPATH_STNDATA, 'all', 'tair_tobs_adj_1948_2012.nc')
